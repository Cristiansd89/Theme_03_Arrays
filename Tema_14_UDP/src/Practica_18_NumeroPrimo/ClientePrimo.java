package Practica_18_NumeroPrimo;
...
public class ClientePrimo {
	...
	public static void main(String[] args) {
		...
		try { 
			...
			flujoSalida.writeInt(palindromo); //Envio del Objeto
			flujoSalida.close();
			...
			boolean esPrimo =  flujoEntrada.readBoolean(); // Lectura del objeto
			flujoEntrada.close();
