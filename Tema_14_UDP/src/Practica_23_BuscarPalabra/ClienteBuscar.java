...
public class ClienteBuscar {
	...
	public static void main(String[] args) {
		...
		try { 
			...
			String [] palabras = {"camion", "Regla","Estufa","Salchichon","mesa"};
			...
			boolean palabraExiste =  flujoEntrada.readBoolean(); // Lectura del objeto
			flujoEntrada.close();
			...
			if(palabraExiste) {
				System.out.println("Esa palabra esta en la lista");
			}else {
				System.out.println("No Esta la palabra en la lista");
			}
