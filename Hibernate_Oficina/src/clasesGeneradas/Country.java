...
// Generated 18 ene 2022 12:49:08 by Hibernate Tools 5.5.7.Final
...
public class Country implements java.io.Serializable {
	...
	public Country(String code, String name, String continent, String region, BigDecimal surfaceArea, Short indepYear,
			...
			String governmentForm, String headOfState, Integer capital, String code2, Set countrylanguages,
			Set cities) {
		this.code = code;
		this.name = name;
		this.continent = continent;
